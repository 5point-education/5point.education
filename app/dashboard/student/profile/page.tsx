...
import { StudentAcademicCard } from "@/components/dashboard/StudentAcademicCard";
  ...
  return (
    <div className="space-y-6 sm:space-y-8 px-4 py-6 sm:p-6 md:p-8 pt-20 max-w-7xl mx-auto pb-20">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground text-sm">Your account details and academic info.</p>
      </div>
