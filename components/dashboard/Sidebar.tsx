            ...
            case "ADMIN":
                return (
                    <>
                        ...
                        <SidebarItem icon={BarChart3} label="Reports" href="/dashboard/admin/reports" onClick={closeMobileSidebar} />
                        ...
                        <SidebarItem icon={AlertTriangle} label="Admission Review" href="/dashboard/reception/admissions-review" onClick={closeMobileSidebar} />
            ...
            case "RECEPTIONIST":
                return (
                    <>
                        ...
                        <SidebarItem icon={IndianRupee} label="Fee Reconciliation" href="/dashboard/reception/fees/reconciliation" onClick={closeMobileSidebar} />
                        <SidebarItem icon={IndianRupee} label="Teachers Fees" href="/dashboard/reception/teacher-fees" onClick={closeMobileSidebar} />
                        <SidebarItem icon={Calendar} label="Attendance" href="/dashboard/reception/attendance" onClick={closeMobileSidebar} />
                        <SidebarItem icon={Megaphone} label="Notices" href="/dashboard/reception/notices" onClick={closeMobileSidebar} />
